...
const LiquidityHeldLineChart = (props: any) => {
  ...
  return (
    <ResponsiveContainer width="100%" height={185}>
      ...
      >
        ...
        />
        <defs>
          <linearGradient id="lhLineGradient" x1="0" y1="0" x2="1" y2="0">
...
export default LiquidityHeldLineChart;
